...
RecordReader.prototype.push = function (buf) {
  this.cursor = this.cursor.push(buf);
};

RecordReader.prototype.leftInBuffer = function () {
  return this.cursor.length - this.cursor.tell();
};
...
RecordReader.prototype.lastSize = function () {
  var size = this.cursor.tell() - this._lastStart;
  return size;
};
...
RecordReader.prototype.readRecord = function () {
  ...
  this._lastStart = this.cursor.tell();
